...
- Update the relevant project and Antora documentation whenever a change affects documented behavior, configuration,
  setup, operations, or user workflows.
- Update `docs/roadmap.md` and `docs/modules/ROOT/pages/compatibility.adoc` when adding, removing, or materially
  changing ActivityPub or Mastodon-compatible behavior.
