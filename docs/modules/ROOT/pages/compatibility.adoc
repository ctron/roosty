...
pagination. Authenticated v1/v2 account suggestions rank eligible locally known accounts by
accepted local followers and recent activity, with offset pagination and durable per-account
dismissals. Ranking considers a bounded pool of recently active known accounts.
