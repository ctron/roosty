...
The local and remote account tables show 25 accounts at a time with Previous and Next navigation.
Select the Account, Email, Role, State, or Created column heading to sort it and select it again to
reverse the direction. Email and Role apply only to local accounts. Search, sorting, and pagination
are preserved in the page URL.
